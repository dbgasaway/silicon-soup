...
public class SiliconSoup {
	...
	private static final byte[] BASE_CELL_CODE = {Code.NOP1, Code.NOP1, Code.NOP1, 
		...
		Code.SEARCHB, Code.NOP0, Code.NOP0, Code.NOP0, Code.NOP0, Code.SUBACA, 
		Code.LOADAB, Code.SEARCHF, Code.NOP0, Code.NOP0, Code.NOP0, Code.NOP1, 
		Code.INCA, Code.SUBACB, Code.NOP1, Code.NOP1, Code.NOP0, Code.NOP1, 
		...
		Code.NOP0, Code.NOP1, Code.IFCZ, Code.NOP1, Code.NOP0, Code.NOP1, Code.NOP0, 
